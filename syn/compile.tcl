...
set_max_fanout 20.0 bert_encoder
...
# Netlist files
write -format ddc -hierarchy -output netlist/bert_encoder_syn.ddc
write_file -format verilog -hierarchy -output netlist/bert_encoder_syn.v
write_sdf -version 2.1 -significant_digits 4 -context verilog netlist/bert_encoder_syn.sdf
write_sdc netlist/bert_encoder_syn.sdc
write_saif -output netlist/bert_encoder_syn.saif 
